...
<html lang="pt-br">
  ...
  <body>
    ...
    <section class="images">
      ...
      <img src="assets/imagens/image-login.png" id="animated-image" alt="" /> <!--estrutura Flask puxar as imagens no html-->
    </section>

    <button class="botao-sair" onclick="cadastrar()">Cadastro</button> 
  </body>
</html>
