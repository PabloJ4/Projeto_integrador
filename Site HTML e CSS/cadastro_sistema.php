...
<head>
    ...
    <link rel="stylesheet" href="assets/css/Style-cadastro-sistema.css">
...
<body>
    <main>
        <a href="tela_login.php">
            <img src="assets/imagens/LOGO-FACE-PASS.png" alt="" >
        </a>
        <h1>Faça seu cadastro</h1>
       <!--Formulario Cadastro Usuário-->
        
        
        <form id="login-form"  action="cadastro_sistema.php" method="POST" >
          ...
          <input type="tel" id="phone" name="telefone" pattern="[0-9]{11}" placeholder ="Seu telefone" required> 

          <label for="text">CPF*</label>
          <input type="text" name="CPF" pattern="[0-9]{3}.[0-9]{3}.[0-9]{3}-[0-9]{2}" title="Insira um CPF 
          válido, no formato 000.000.000-00" placeholder="000.000.000-00"  required >
         
          <label for="text">Data de Nascimento*</label>
          <input type="date" name="data_nascimento"   list="opcao2" placeholder="00/00/0000" required >
    ...
    <section class="images">
        ...
        <img src="assets/imagens/imagem tela-cadastro.png" id="animated-image" alt="">
        
    </section>

    <button class="botao-sair" onclick="voltar()"; return false >Voltar</button>
